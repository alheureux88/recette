...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    ...
    "recipe.source_label": {"fr": "Source", "en": "Source"},
    "recipe.date_label": {"fr": "Date", "en": "Date"},
    # --- Mode cuisine ---
    ...
    "admin.filter_no_url": {"fr": "Sans URL", "en": "Without URL"},
    "admin.filter_no_source": {"fr": "Sans source", "en": "Without source"},
    "admin.filter_no_date": {"fr": "Sans date", "en": "Without date"},
    ...
    "admin.tab_source": {"fr": "Source", "en": "Origin"},
    "admin.tab_date": {"fr": "Date", "en": "Date"},
    ...
    "admin.field_source": {"fr": "Source", "en": "Source"},
    "admin.field_date": {"fr": "Date", "en": "Date"},
    ...
    "collections.site_title": {
        "fr": "Collections du site",
        "en": "Site collections",
    },
    "collections.mine_title": {"fr": "Mes collections", "en": "My collections"},
    "collections.empty_site": {
        "fr": "Aucune collection pour le moment.",
        "en": "No collections yet.",
    },
    "collections.empty_mine": {
        "fr": "Vous n'avez pas encore de collection. Créez-en une !",
        "en": "You have no collections yet. Create one!",
    },
    "collections.login_hint": {
        "fr": "Connectez-vous pour créer vos propres collections.",
        "en": "Log in to create your own collections.",
    },
    "collections.new": {"fr": "Nouvelle collection", "en": "New collection"},
    "collections.create": {"fr": "Créer", "en": "Create"},
    "collections.name_placeholder": {
        "fr": "Ex : Recettes pour Noël",
        "en": "E.g.: Christmas recipes",
    },
    "collections.description_placeholder": {
        "fr": "Petit texte de présentation (optionnel)",
        "en": "Short description (optional)",
    },
    "collections.recipes_count_one": {"fr": "{n} recette", "en": "{n} recipe"},
    "collections.recipes_count_other": {"fr": "{n} recettes", "en": "{n} recipes"},
    "collections.featured_title": {
    ...
    "collections.or_create": {
        "fr": "Ou créer une nouvelle collection",
        "en": "Or create a new collection",
    },
    ...
    "collections.share": {"fr": "Partager", "en": "Share"},
    "collections.share_link_copied": {"fr": "Lien copié!", "en": "Link copied!"},
    "collections.rename": {"fr": "Renommer", "en": "Rename"},
    "collections.delete": {"fr": "Supprimer la collection", "en": "Delete collection"},
    "collections.confirm_delete": {
        "fr": "Supprimer cette collection définitivement ?",
        "en": "Delete this collection permanently?",
    },
    "collections.remove_recipe": {"fr": "Retirer", "en": "Remove"},
    "collections.empty_recipes": {
        "fr": "Aucune recette dans cette collection.",
    ...
    "admin.collections_col_name": {"fr": "Nom", "en": "Name"},
    "admin.collections_col_owner": {"fr": "Propriétaire", "en": "Owner"},
    "admin.collections_col_recipes": {"fr": "Recettes", "en": "Recipes"},
    "admin.collections_col_status": {"fr": "Statut", "en": "Status"},
    "admin.collections_col_featured": {"fr": "En avant", "en": "Featured"},
    "admin.collections_col_created": {"fr": "Créée le", "en": "Created"},
    "admin.collections_col_actions": {"fr": "Actions", "en": "Actions"},
    "admin.collections_status_site": {"fr": "Site", "en": "Site"},
    "admin.collections_status_user": {"fr": "Usager", "en": "User"},
    "admin.collections_featured_yes": {"fr": "Oui", "en": "Yes"},
    "admin.collections_featured_no": {"fr": "Non", "en": "No"},
    "admin.collections_action_view": {"fr": "Voir", "en": "View"},
    "admin.collections_action_promote": {"fr": "Passer site", "en": "Make site"},
    "admin.collections_action_demote": {"fr": "Repasser usager", "en": "Make user"},
    "admin.collections_action_feature": {"fr": "Mettre en avant", "en": "Feature"},
    "admin.collections_action_unfeature": {"fr": "Retirer l'avant", "en": "Unfeature"},
    "admin.collections_action_delete": {"fr": "Supprimer", "en": "Delete"},
    "admin.collections_confirm_delete": {
        "fr": "Supprimer cette collection définitivement?",
        "en": "Delete this collection permanently?",
    },
    "admin.collections_empty": {"fr": "Aucune collection", "en": "No collections"},
